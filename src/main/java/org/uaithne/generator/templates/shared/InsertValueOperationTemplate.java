...
public class InsertValueOperationTemplate extends ClassTemplate {

    public InsertValueOperationTemplate(String packageName) {
        setPackageName(packageName);
        setClassName("InsertValueOperation");
