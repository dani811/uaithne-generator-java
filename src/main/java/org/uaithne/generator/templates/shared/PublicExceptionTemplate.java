...
public class PublicExceptionTemplate extends ClassTemplate {

    public PublicExceptionTemplate(String packageName) {
        setPackageName(packageName);
        setClassName("PublicException");
        setExtend("RuntimeException");
    }

    @Override
    protected void writeContent(Appendable appender) throws IOException {
        appender.append("    public PublicException() {\n"
                + "    }\n"
                + "\n"
