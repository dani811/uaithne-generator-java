...
public class JustInsertValueOperationTemplate extends ClassTemplate {

    public JustInsertValueOperationTemplate(String packageName) {
        setPackageName(packageName);
        setClassName("JustInsertValueOperation");
